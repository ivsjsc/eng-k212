  ...
  const t = {
    ...
    vi: {
      ...
      guest: 'Dùng thử với vai trò khách',
        {/** compute shade from buttonColor (e.g. 'bg-blue-500' -> 'blue-500') and apply bg-opacity and text color properly **/}
        {(() => {
          const shade = buttonColor.replace(/^bg-/, ''); // e.g. 'blue-500'
          return (
              ...
              <button
                ...
                const RoleSelectionPage: React.FC<RoleSelectionPageProps> = ({
                  ...
                  const RoleCard = ({
                    ...
                    // Safely compute the color shade (e.g. 'bg-blue-500' -> 'blue-500')
